...
_T: dict[str, dict[str, str]] = {
    ...
    "rem.days_title": {
        "ru": "Через сколько дней? (потом выберешь время)",
        "en": "In how many days? (time next)",
        "de": "In wie vielen Tagen? (Zeit danach)",
    },
    ...
    "rem.d.other": {"ru": "✏️ Своё (дата)", "en": "✏️ Custom (date)", "de": "✏️ Eigenes (Datum)"},
    "rem.exact_btn": {
...
_UK: dict[str, str] = {
    ...
    "rem.days_title": "За скільки днів? (час обереш далі)",
    "rem.d.week": "Тиждень",
    "rem.d.month": "Місяць",
    "rem.d.halfyear": "Півроку",
    "rem.d.year": "Рік",
    "rem.d.other": "✏️ Своє (дата)",
